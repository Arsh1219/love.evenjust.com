  ...
  return (
    <>
      ...
      <div className="mt-3 mx-auto w-64" data-tooltip="Copied">
        <CopyToClipboard text={url} onCopy={() => showToolTip()}>
      ...
      <div className="my-3 mx-auto w-full md:w-2/3">
        <SmallButton
          ...
          onClick={() => (window.location.href = `${timelineUrl}`)}
        />
      </div>
      <div className="my-1 flex">
        <SharableIcon
          color="#1cb06d"
          icon={<WhatsAppIcon />}
          href={`https://api.whatsapp.com/send?text=❤ *Amazing Astrology Love Calculator* ❤ %0D%0ACalculate Love Percentage Between You and Your Partner 😻😻%0D%0A‼👇👇👇👇👇👇‼ %0D%0A ${url}`}
        />
        <SharableIcon
      ...
      <SharableIcons url={url} name={getUserName()} />
    </>
  );
};
